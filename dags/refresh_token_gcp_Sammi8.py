...
def get_latest_ac_token_gcp2():
    ...
    with client:
        query_job = client.query(
            "SELECT * FROM `affable-hydra-422306-r3.airflow.tokens_Sammi8` ORDER BY access_last_update DESC LIMIT 1")
...
def get_latest_refresh_token_gcp():
    ...
    with client:
        query_job = client.query(
            "SELECT * FROM `affable-hydra-422306-r3.airflow.tokens_Sammi8` ORDER BY refresh_last_update DESC LIMIT 1")
        rows = query_job.result()
...
def request_new_ac_token_refresh_token_gcp2():
    ...
    client_id = '4d0db14d92134467a1954d65667eede0'
    client_secret = 'eea37408ec914d37897a0ebd500dbc27'
    ...
    with client:
        try:
            query_job = client.query(
                f"INSERT INTO airflow.tokens_Sammi8 (access_token, access_last_update, refresh_token, refresh_last_update) \
