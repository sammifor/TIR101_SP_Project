...
from refresh_token_gcp_Sammi5 import get_latest_ac_token_gcp2, request_new_ac_token_refresh_token_gcp2
...
def get_track_data2(**context):
    ...
    if is_last_uri_last_in_list(track_uris, last_track_uri):
...
with DAG('spotify_GetTrack_Sammi_copy.py',
...
# Order of DAGs
check_if_need_update_token >> get_track_data >> get_track_data1
...
get_track_data2.set_upstream(get_track_data1)
