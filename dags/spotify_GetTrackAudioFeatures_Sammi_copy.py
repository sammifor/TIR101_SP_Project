...
# Order of DAGs
check_if_need_update_token >> get_track_audio_features_data >> get_track_audio_features_data1
...
get_track_audio_features_data2.set_upstream(get_track_audio_features_data1)


#data1&data2兩個上游任務執行完成才會執行process_data_from_gcs
process_data_from_gcs.set_upstream(
    [get_track_audio_features_data1, get_track_audio_features_data2]
)
