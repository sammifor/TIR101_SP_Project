...
def get_latest_ac_token_gcp2():
    ...
    with client:
        query_job = client.query(
            "SELECT * FROM `affable-hydra-422306-r3.airflow.tokens_Sammi3` ORDER BY access_last_update DESC LIMIT 1")
...
def get_latest_refresh_token_gcp():
    ...
    with client:
        query_job = client.query(
            "SELECT * FROM `affable-hydra-422306-r3.airflow.tokens_Sammi3` ORDER BY refresh_last_update DESC LIMIT 1")
        rows = query_job.result()
...
def request_new_ac_token_refresh_token_gcp2():
    ...
    client_id = '987a7db4a97e4a048b4a87cb9a4d4cf9'
    client_secret = 'be43dbd1ebae4f23b29a365f146c7157'
    ...
    with client:
        try:
            query_job = client.query(
                f"INSERT INTO airflow.tokens_Sammi3 (access_token, access_last_update, refresh_token, refresh_last_update) \
